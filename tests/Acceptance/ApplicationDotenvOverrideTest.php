...
class ApplicationDotenvOverrideTest extends TestCase
{
    public function test_application_execution()
    {
        $application = new Application(__DIR__ . '/_app_dotenv_override');
        ...
        static::assertNotFalse(strpos(MockWriter::$content, ' echo test3'));
        static::assertNotFalse(strpos(MockWriter::$content, 'test3'));
